...
module.exports = {
  name: "listservers",
  description: "lista todos/os servidores correspondentes",
  category: "OWNER",
  ...
  async messageRun(message, args) {
    ...
    if (totalPages === 0) return message.safeReply("Nenhum servidor encontrado");
    let currentPage = 1;
    ...
    const buildEmbed = () => {
      ...
      const embed = new EmbedBuilder()
        ...
        .setFooter({
          text: `${match ? "Correspondido" : "Total"} Servers: ${total} • Pagina ${currentPage} de ${totalPages}`,
        });
